...
export const DEFAULT_CLAMAV_TIMEOUT = 120;
...
export const DEFAULT_MAX_FILE_COUNT = 32000; // number of files in a single request
export const DEFAULT_MAX_FILE_SIZE = 200 * 1024 * 1024; // 200 MB
